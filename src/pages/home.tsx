    ...
    return (
        <Container className={`page home ${ theme }`} fluid>
            ...
            <Row className="home-screen" >
                ...
                <img className="home-image" src={ theme === "light" ? HomeImageLight : HomeImageDark } alt="Bunny and moon" ></img>
                <img className="home-background" src={ theme === "light" ? HomeBackgroundLight : HomeBackgroundDark } alt="Speckles"></img>
            </Row>
                    ...
                    <div className="box">
                        {
                            activeBox !== "greeting" ? <StarsIcon className="icon" /> : (
                                <>
                                    ...
                                    P.S. I suggest you create an account <NavLink onClick={e => e.stopPropagation()} className="link" to={ internalEndpoints.register! }>here</NavLink> to explore all the features.<br/>
                                    <br/>
                                    - Tracey
                                </>
                            )
