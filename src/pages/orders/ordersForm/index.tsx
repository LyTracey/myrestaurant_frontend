...
function OrderForm() {
  ...
  updateObj.menu_items = Object.keys(menu).map((menuID: string) =>
    updateObj.menu_items.includes(Number(menuID)) ? menuID : false
  )
  ...
  return (
    <Modal
      className={theme}
      show={true}
      onHide={() => navigate(internalEndpoints.orders!)}
    >
                ...
                return (
                  ...
                  >
                    ...
                    <span className="availability">
                      Availability: {availabilities[menuArray[0]]}
                    </span>
                  </div>
                )
              })}
