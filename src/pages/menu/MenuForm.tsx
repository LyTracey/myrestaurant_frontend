...
function MenuForm () {
    ...
    return (
        <Modal className={ theme } show={ true } onHide={() => navigate(internalEndpoints.menu!)}>
            ...
            <Modal.Body>
                ...
                
                {
                    ...
                    <div className="actions">
                        <button title="Delete menu item" type="button" className="button delete" onClick={() => setShowDelete(true)}>
                            <DeleteIcon /> Delete
                        </button>
                    </div>
                }
                        ...
                        <div className="ingrdients">
                            <label>Available ingredients</label>
                            {
                                Object.entries(inventory).map((inventoryArray: any, i: number) => {
                                    return (
                                        <div className="check-input-container" key={`ingredients_reference_${i}`}>
                                            <Form.Check
                                            ...
                                            />
                                            <Form.Label className="input-label check-label">{ inventoryArray[1] }</Form.Label>
                                        </div>
                                    )
                                })
                            }
