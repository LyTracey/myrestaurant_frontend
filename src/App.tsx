...
import { InventoryLoader, MenuLoader, OrdersLoader, OrdersArchiveLoader, UserLoader } from "./api/loaders";
import MenuForm from "./pages/menu/MenuForm";
import RootErrorBoundary from "./messages/error";
import OrderForm from "./pages/orders/OrdersForm";
import { createInterceptors, dataAPI, userAPI } from "./api/axiosInstances";
import { SuccessfullyRegistered } from "./messages/success";
