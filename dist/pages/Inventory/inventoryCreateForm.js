...
function InventoryCreateForm(props) {
    ...
    return (_jsxs(Modal, Object.assign({ className: `inventory-form page-form ${props.theme}`, show: props.addItem, onHide: () => {
            props.onHide();
            setValidated(false);
        } }, { children: [_jsx(Modal.Header, Object.assign({ closeButton: true }, { children: _jsx(Modal.Title, { children: "New Inventory Item" }) })), _jsx(Modal.Body, { children: _jsxs(Form, Object.assign({ noValidate: true, validated: validated, onSubmit: e => handleSubmit(e) }, { children: [EditFieldGroup({
