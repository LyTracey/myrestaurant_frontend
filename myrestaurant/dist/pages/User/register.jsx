...
function Register() {
    ...
    return (<Container className={`register-form form ${useContext(ThemeContext)}`}>
            ...
            <Form noValidate validated={validated} className="form" onSubmit={e => handleSubmit(e)}>
                ...
                <Form.Group as={Row} xs={1} className="group password">
                    ...
                    <Col className="field">
                        <Form.Control type="password" name="password1" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" placeholder="Create password" onChange={e => { handleData(e.target.name, e.target.value); }} required/>
                        <Form.Control.Feedback type="invalid">
                ...
                <Form.Group as={Row} xs={1} className="group password">
                    ...
                    <Col className="field">
                        <Form.Control type="password" name="password2" placeholder="Re-enter password" onChange={e => handleData(e.target.name, e.target.value)} required/>
                    </Col>
                </Form.Group>

                <Form.Group as={Row} xs={1} className="group is-staff">
                    <Col>
                        <Form.Check type="checkbox" label="Staff View" name="is_staff" onChange={e => handleData(e.target.name, e.target.value)}/>
                    </Col>
                </Form.Group>
