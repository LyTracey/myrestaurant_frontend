...
function OrderUpdateForm(props) {
    ...
    const Availability = (<>
            ...
            return (<Form.Text as="div" className="multi-read-field availability" key={`availability_${i}`}>
    ...
    return (<Modal className={`orders-form form ${props.theme}`} show={props.updateItem} onHide={() => {
