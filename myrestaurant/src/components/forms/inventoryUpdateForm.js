...
function InventoryUpdateForm(props) {
    ...
    return (_jsxs(Modal, __assign({ className: "inventory-form ".concat(props.theme), show: props.updateItem, onHide: function () {
            ...
            props.onHide();
        } }, { children: [_jsx(Modal.Header, __assign({ closeButton: true }, { children: _jsx(Modal.Title, { children: "Update Inventory Item" }) })), _jsxs(Modal.Body, { children: [_jsx(Form, __assign({ onSubmit: function (e) { return props.handleSubmit(e, "update", props.updateInventory); } }, { children: _jsxs(Container, { children: [_jsxs(Form.Group, __assign({ className: "id", as: Row, sm: 2 }, { children: [_jsx(Form.Label, __assign({ column: true, sm: 3 }, { children: "ID" })), _jsx(Col, __assign({ className: "field", sm: 9 }, { children: _jsx(Form.Control, { type: "text", name: "id", defaultValue: (_a = String(props.updateInventory.id)) !== null && _a !== void 0 ? _a : 0, readOnly: true, disabled: true }) }))] })), _jsxs(Form.Group, __assign({ className: "ingredient", as: Row, sm: 2 }, { children: [_jsx(Form.Label, __assign({ column: true, sm: 3 }, { children: "Ingredient" })), _jsx(Col, __assign({ className: "field", sm: 9 }, { children: _jsx(Form.Control, { type: "text", name: "title", defaultValue: props.updateInventory.ingredient, readOnly: true, disabled: true }) }))] })), _jsxs(Form.Group, __assign({ className: "quantity", as: Row, sm: 2 }, { children: [_jsx(Form.Label, __assign({ column: true, sm: 3 }, { children: "Quantity Available" })), _jsx(Col, __assign({ className: "field", sm: 9 }, { children: _jsx(Form.Control, { type: "number", name: "quantity", step: "0.01", defaultValue: props.updateInventory.quantity, onChange: function (e) { return props.handleData(e.target.name, e.target.value, "update"); } }) }))] })), _jsxs(Form.Group, __assign({ className: "unit_price", as: Row, sm: 2 }, { children: [_jsx(Form.Label, __assign({ column: true, sm: 3 }, { children: "Unit Price" })), _jsx(Col, __assign({ className: "field", sm: 9 }, { children: _jsx(Form.Control, { type: "number", name: "price", step: "0.01", required: true, defaultValue: props.updateInventory.unit_price, onChange: function (e) { return props.handleData(e.target.name, Number(e.target.value), "update"); } }) }))] })), _jsxs(Row, __assign({ className: "form-actions", lg: 8 }, { children: [_jsx(Button, __assign({ type: "submit", className: "submit" }, { children: "Submit" })), _jsx(Button, __assign({ type: "button", className: "delete", onClick: function () { return setDeleteAlert(true); } }, { children: "DELETE" }))] }))] }) })), deleteAlert &&
