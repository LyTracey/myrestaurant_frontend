...
function MenuUpdateForm(props) {
    ...
    return (_jsxs(Modal, __assign({ className: "menu-form ".concat(props.theme), show: props.updateItem, onHide: function () {
            ...
            props.onHide();
        } }, { children: [_jsx(Modal.Header, __assign({ closeButton: true }, { children: _jsx(Modal.Title, { children: "Update Menu Item" }) })), _jsxs(Modal.Body, { children: [_jsx(Form, __assign({ onSubmit: function (e) { return props.handleSubmit(e, "update", props.updateMenu); } }, { children: _jsxs(Container, { children: [_jsxs(Form.Group, __assign({ className: "field-group id", as: Row, sm: 2 }, { children: [_jsx(Form.Label, __assign({ column: true, sm: 3 }, { children: "ID" })), _jsx(Col, __assign({ className: "field", sm: 9 }, { children: _jsx(Form.Control, { type: "text", name: "id", defaultValue: props.updateMenu.id, readOnly: true, disabled: true }) }))] })), _jsxs(Form.Group, __assign({ className: "field-group title", as: Row, sm: 2 }, { children: [_jsx(Form.Label, __assign({ column: true, sm: 3 }, { children: "Title" })), _jsx(Col, __assign({ className: "field", sm: 9 }, { children: _jsx(Form.Control, { type: "text", name: "title", defaultValue: props.updateMenu.title, readOnly: true, disabled: true }) }))] })), _jsxs(Form.Group, __assign({ className: "field-group description", as: Row, sm: 2 }, { children: [_jsx(Form.Label, __assign({ column: true, sm: 3 }, { children: "Description" })), _jsx(Col, __assign({ className: "field", sm: 9 }, { children: _jsx(Form.Control, { type: "text", name: "description", defaultValue: props.updateMenu.description, onChange: function (e) { return props.handleData(e.target.name, e.target.value, "update"); } }) }))] })), _jsxs(Form.Group, __assign({ className: "field-group price", as: Row, sm: 2 }, { children: [_jsx(Form.Label, __assign({ column: true, sm: 3 }, { children: "Price" })), _jsx(Col, __assign({ className: "field", sm: 9 }, { children: _jsx(Form.Control, { type: "number", name: "price", step: "0.01", required: true, defaultValue: props.updateMenu.price, onChange: function (e) { return props.handleData(e.target.name, Number(e.target.value), "update"); } }) }))] })), _jsxs(Row, __assign({ sm: 4, className: "field-group ingredients-units" }, { children: [_jsx(Col, __assign({ sm: 3, className: 'ingredients label' }, { children: _jsx(Form.Label, { children: "Ingredients" }) })), _jsx(Col, __assign({ sm: 4, className: "ingredients multi-input" }, { children: Object.entries(props.ingredients).map(function (item, i) {
