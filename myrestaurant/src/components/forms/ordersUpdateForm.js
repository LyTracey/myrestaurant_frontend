...
function OrderUpdateForm(props) {
    ...
    return (_jsxs(Modal, __assign({ className: "orders-form ".concat(props.theme), show: props.updateItem, onHide: function () {
            ...
            props.onHide();
        } }, { children: [_jsx(Modal.Header, __assign({ closeButton: true }, { children: _jsx(Modal.Title, { children: "Update Order Item" }) })), _jsxs(Modal.Body, { children: [_jsx(Form, __assign({ onSubmit: function (e) { return props.handleSubmit(e, "update", props.updateOrder); } }, { children: _jsxs(Container, { children: [_jsxs(Form.Group, __assign({ className: "field-group id", as: Row, sm: 2 }, { children: [_jsx(Form.Label, __assign({ column: true, sm: 3 }, { children: "ID" })), _jsx(Col, __assign({ className: "field", sm: 9 }, { children: _jsx(Form.Control, { type: "text", name: "id", defaultValue: props.updateOrder.id, readOnly: true, disabled: true }) }))] })), _jsxs(Form.Group, __assign({ className: "field-group notes", as: Row, sm: 2 }, { children: [_jsx(Form.Label, __assign({ column: true, sm: 3 }, { children: "Notes" })), _jsx(Col, __assign({ className: "field", sm: 9 }, { children: _jsx(Form.Control, { type: "text", name: "notes", defaultValue: props.updateOrder.notes, onChange: function (e) { return props.handleData(e.target.name, e.target.value, "update"); } }) }))] })), _jsxs(Row, __assign({ sm: 4, className: "field-group menu-quantity" }, { children: [_jsx(Col, __assign({ sm: 3, className: 'menu-items label' }, { children: _jsx(Form.Label, { children: "Menu Items" }) })), _jsx(Col, __assign({ sm: 4, className: "menu-items multi-input" }, { children: Object.entries(props.menu).map(function (item, i) {
                                                return (_jsxs(Form.Group, { children: [_jsx(Form.Check, { className: "field", type: "checkbox", label: item[1].title, name: "menu_items", value: item[0], checked: props.updateOrder.menu_items.includes(Number(item[0])), onChange: function (e) { return props.handleQuantity(String(item[0]), e.target.checked, "update", props.updateOrder); } }, i), _jsxs(Form.Control.Feedback, __assign({ type: "invalid" }, { children: ["Available: ", item[1].available_quantity] }))] }));
