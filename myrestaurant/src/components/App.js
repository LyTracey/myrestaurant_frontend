...
function App() {
    ...
    return (_jsxs("div", __assign({ className: "App ".concat(theme) }, { children: [_jsx(Navbar, { theme: theme, setTheme: setTheme }), _jsx(Router, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/dashboard/", element: _jsx(Dashboard, { theme: theme }) }), _jsx(Route, { path: "/menu/", element: _jsx(Menu, { theme: theme }) }), _jsx(Route, { path: "/inventory/", element: _jsx(Inventory, { theme: theme }) }), _jsx(Route, { path: "/orders/", element: _jsx(Orders, { theme: theme }) })] }) })] })));
}
export default App;
