...
interface SelectMultiFieldGroup {
...
export function SelectMultiFieldGroup ({name, data, reference, values_obj, items_list, setObj}: SelectMultiFieldGroup, options: object = {}) {
    /*
...
interface InputMultiFieldGroup {
...
export function InputMultiFieldGroup ({type, reference, data, values_obj, items_list, name, setObj, feedback}: InputMultiFieldGroup, options: object = {}) {
    /*
